...
class ImagePixelData(TypedDict):
    image_pixel_data: object | str
    mime_type: str
    # onnx_image_data: object
...
class TextPrompt(TypedDict):
    ...
    multi_modal_data: Optional[ImagePixelData]
    """
...
class LLMInputs(TypedDict):
    ...
    multi_modal_data: NotRequired[Optional[ImagePixelData]]
